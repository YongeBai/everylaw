...
export default function RatePage() {
  return <main className="shell py-10">
    ...
    <p className="mt-10 text-xs text-[#68736d]">Verdicts are anonymous public signals, not a referendum. Official text is public domain; summaries are AI-generated and not legal advice.</p>
  </main>;
}
