...
export default async function FrontPage({ searchParams }: { searchParams: Promise<{ sort?: string }> }) {
  ...
  const posts = await getRPosts(sort);
    ...
    <div className={styles.shell}>
      ...
      <aside className={styles.side}>
        <div className={styles.sideBox}><h2>everylaw</h2><div className={styles.sideBoxBody}>
          ...
          <div className={styles.sideStat}><span>sections in force</span><b>60,444</b></div>
          <div className={styles.sideStat}><span>titles</span><b>54</b></div>
        ...
        <div className={styles.sideBox}><h2>random law</h2><div className={styles.sideBoxBody}>
          <p>An endless stack from all 60,173 sections in force.</p>
