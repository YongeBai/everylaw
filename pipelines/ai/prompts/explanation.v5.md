...
Length scales with what the reader needs, not with the statute: most sections deserve 150–400 words; a genuinely complex section takes what clarity requires. Return only the translation: no title, no preface, no closing disclaimer.
